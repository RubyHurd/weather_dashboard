...
var searchArr = [];
var APIKey = "be9e34dc1837a360f06d060358c5c2ff";
...
$(document).ready(function () {
    ...
    function triggerSearch(citySearch) {
        ...
        $.ajax({
            ...
            var day5QueryURL = "https://api.openweathermap.org/data/2.5/onecall?lat=" + latitude + "&lon=" + longitude + "&units=imperial" + APIKey;
